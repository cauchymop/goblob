...
public class GoGameTest {
  ...
  public void testUndo() {
    ...
    assertThat(goGame).isEqualTo(new GoGame(9));
  }

  @Test
  public void testEquals() {
    GoGame goGame9A = new GoGame(9);
    GoGame goGame9B = new GoGame(9);
    GoGame goGame9C = goGame9A.copy();

    GoGame goGame13A = new GoGame(13);
    GoGame goGame13B = new GoGame(13);
    GoGame goGame13C = goGame13A.copy();

    GoGame goGame19A = new GoGame(19);
    GoGame goGame19B = new GoGame(19);
    GoGame goGame19C = goGame19A.copy();

    GoGame goGameMoveA = new GoGame(19);
    goGameMoveA.play(7);
    GoGame goGameMoveB = new GoGame(19);
    goGameMoveB.play(7);
    GoGame goGameMoveC = goGameMoveA.copy();

    GoGame goGameOtherMoveA = new GoGame(19);
    goGameOtherMoveA.play(11);
    GoGame goGameOtherMoveB = new GoGame(19);
